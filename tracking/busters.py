...
if __name__ == '__main__':
    ...
    """
    # print("SONAR_NOISE_VALUES is: ", SONAR_NOISE_VALUES)
    # print("SONAR_DENOMINATOR is: ", SONAR_DENOMINATOR)
    # print("SONAR_NOISE_PROBS is: ", SONAR_NOISE_PROBS)
    # print(sum(SONAR_NOISE_PROBS))
    # pass
